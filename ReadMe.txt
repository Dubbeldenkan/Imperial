...
- Öppna visual studio och höger klicka på "Direct3DWrapper, öppna properties, välj Configuration: all configuration.
	- VC++ Directories
		...
		Om det inte funkar kolla om DXSDK_DIR finns under miljövariabler. Om det fortfarande inte funkar. Lös det som nedan. 
...
Man bör dessutom högerklicka på solution och välja properties samt project dependencies.

Dessutom måste man lägga till Direct3DWrapper under reference för "Game". Reference hittar man i direkt under "Game" under solution explorer. 